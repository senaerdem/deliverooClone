...
const ItemBox = () => (
    ...
    <View style={styles.itemContainer}>
        <TouchableOpacity style={styles.item}>
            <Ionicons name="arrow-down-outline" size={20} color={Colors.medium}></Ionicons>
            <Text style={{ flex: 1 }}>Sort</Text>
            <Ionicons name="chevron-forward" size={22} color={Colors.medium}></Ionicons>
        </TouchableOpacity>

        <TouchableOpacity style={styles.item}>
            <Ionicons name="fast-food-outline" size={20} color={Colors.medium}></Ionicons>
            <Text style={{ flex: 1 }}>Hygiene rating</Text>
            <Ionicons name="chevron-forward" size={22} color={Colors.medium}></Ionicons>
        </TouchableOpacity>

        <TouchableOpacity style={styles.item}>
            <Ionicons name="pricetag-outline" size={20} color={Colors.medium}></Ionicons>
            <Text style={{ flex: 1 }}>Offers</Text>
            <Ionicons name="chevron-forward" size={22} color={Colors.medium}></Ionicons>
        </TouchableOpacity>

        <TouchableOpacity style={styles.item}>
            <Ionicons name="nutrition-outline" size={20} color={Colors.medium}></Ionicons>
